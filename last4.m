...
%defining a frequency mask kernel
freq_filter = zeros(r,c);
freq_filter((r/2)-40:(r/2)+40,(c/2)-50:(c/2)+50)=1;
figure,imshow(freq_filter,[]);
...
mag = abs(freq_filter).*abs(freq_filter);
